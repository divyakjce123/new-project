        ...
        for r in range(num_rows):
            ...
            for c in range(racks_per_row):
                ...
                for f in range(num_floors):
                    ...
                    # --- MODIFIED: Check Pallet Position instead of Stock Position ---
                    pallet_pos = block_conf['pallet_config']['position']
                    if pallet_pos['floor'] == f+1 and pallet_pos['row'] == r+1 and pallet_pos['col'] == c+1:
